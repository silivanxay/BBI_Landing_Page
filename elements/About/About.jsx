              ...
              <div className="relative pt-12 pb-6 sm:p-6 mb-8">
                ...
                <div className="relative">
                  <h2 className="text-2xl md:text-4xl font-semibold tracking-tighter">
                    ພວກເຮົາໃຫ້ບໍລິການ ເວັບ e-Commerce ທີ່ປະສົມປະສານລົງໂຕ ກັບ ຮ້ານຄ້າທີ່ມີໜ້າຮ້ານແທ້,
                    ຊຸກຍູ້ເຄື່ອງມືການຕະຫຼາດດິຈິຕອນ ເພື່ອໃຫ້ ລຸກຄ້າ ເຫັນຮ້ານຂອງທ່ານ ແລ້ວມີຄວາມປະທັບໃຈໃນຄັ້ງທໍາອິດ, ແລະ
