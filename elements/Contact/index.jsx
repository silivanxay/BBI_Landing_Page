          ...
          <div className="flex flex-wrap -mx-4 pb-16">
            <div className="w-full md:w-1/3 px-4 mb-10 md:mb-0">
              <div className="max-w-xs mx-auto text-center">
                <div className="inline-flex mb-6 items-center justify-center w-12 h-12 bg-yellow-500 rounded-full">
                  <svg
            ...
            <div className="w-full md:w-1/3 px-4 mb-10 md:mb-0">
              <div className="max-w-xs mx-auto text-center">
                ...
                <p className="text-xl text-coolGray-500 font-medium">
                  +7-843-672-431
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3 px-4">
              <div className="max-w-xs mx-auto text-center">
                ...
                <a
                  className="inline-block mr-8 text-yellow-500 hover:text-yellow-600"
                  href="#"
                >
                  <svg
                    width={10}
              ...
              <form >
                ...
                <div className="flex flex-wrap items-center justify-between mb-6">
                  ...
                  <div className="w-full md:w-auto mt-1">
                    <a
                      className="inline-block text-xs font-medium text-yellow-500 hover:text-yellow-600"
                      href="#"
                    >
                ...
                <a
                  className="inline-block py-3 px-7 mb-4 w-full text-base text-yellow-50 font-medium text-center leading-6 bg-yellow-500 hover:bg-yellow-600 focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 rounded-md shadow-sm"
                  href="#"
                >
                  Sign Up
                </a>
                ...
                <p className="text-center">
                  ...
                  <a
                    className="inline-block text-xs font-medium text-yellow-500 hover:text-yellow-600 hover:underline"
                    href="#"
                  >
                    Sign In
                  </a>
