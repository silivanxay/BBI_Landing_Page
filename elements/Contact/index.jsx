...
export const Contact = () => {
  return (
    <div>
      <section id="contact" className="pt-20 text-coolGray-900 dark:text-white">
        <div className="container px-4 mx-auto">
          <div
            data-aos="fade-up"
            className="max-w-4xl mx-auto mb-16 text-center"
          >
            <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-coolGray-900 dark:text-white bg-yellow-500 font-medium uppercase rounded-9xl">
              Contact
            </span>
          ...
          <div data-aos="fade-up" className="flex flex-wrap -mx-4 pb-16">
            ...
            <div className="w-full md:w-1/3 px-4">
              <div className="max-w-xs mx-auto text-center">
                ...
                <h3 className="mb-3 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900 dark:text-white">
                  Socials
                </h3>
                <a
