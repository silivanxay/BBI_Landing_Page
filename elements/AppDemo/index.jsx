...
//           </div>
//           <div data-aos="fade-up" className="relative mx-auto max-w-max">
//             <div className="hidden md:block absolute w-5/12 transform -translate-y-1/2 top-1/2">
//               <Image
//                 src="flex-ui-assets/elements/cirlcle-pattern.svg"
//                 alt="image"
//               />
//             </div>
//             <div className="hidden md:block absolute w-5/12 transform -translate-y-1/2 -right-6 lg:-right-16 top-1/2 ">
//               <Image src="flex-ui-assets/elements/blob.svg" alt="image" />
//             </div>
//             <Video
//               src="flex-ui-assets/videos/ecom-mb.mp4"
//               className="absolute z-20 w-5/6 -mt-1 transform -translate-x-1/2 -translate-y-1/2 p-7 left-1/2 top-1/2"
