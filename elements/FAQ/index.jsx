...
export default function index() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          'url("flex-ui-assets/images/testimonials/FAQ background.jpg")',
      ...
      <div className="container px-4 mx-auto">
        <div className="w-max">
          <div className="max-w-md m-auto text-center">
            <span className="px-8 py-px mb-4 font-medium leading-5 text-yellow-500 bg-yellow-100 rounded-full shadow-sm text-7xl">
              ?
            </span>
            <h2 className="my-6 mb-4 text-2xl font-bold leading-tight tracking-tighter text-yellow-500 md:text-3xl">
              Why do you want to use our e-commerce platform ?
            </h2>
          </div>
        </div>
        <div className="flex flex-wrap justify-center my-10 -mx-4">
          <div className="w-full px-4 mb-20 md:w-2/5 md:mb-0">
            <a className="flex flex-wrap w-full mb-10 text-left" href="#">
              <div className="w-full mb-2 md:w-auto md:pr-10 md:mb-0">
                ...
                <p className="max-w-md font-medium text-yellow-300">
                  With our e-commerce platform, job can be done with less staves
                </p>
              </div>
          ...
          <div className="w-full px-4 md:w-2/5">
            <a
              className="flex flex-wrap w-full mb-10 text-left text-yellow-500 hover:text-yellow-600 hover:underline"
              href="#"
            >
              <div className="w-full mb-2 md:w-auto md:pr-10 md:mb-0">
                <h3 className="text-xl font-bold text-yellow-500">
                  Customers can buy your product non-stop via online shop 24/7
                </h3>
              </div>
