...
export default function index() {
  return (
    <section
      ...
      className="py-24"
      style={{
        backgroundImage: 'url("flex-ui-assets/images/testimonials/image.webp")',
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          <div className="w-full px-4 mb-20 md:w-2/5 md:mb-0">
            <a className="flex flex-wrap w-full mb-10 text-left" href="#">
              <div className="w-full mb-2 md:w-auto md:pr-10 md:mb-0">
                <h3 className="mb-4 text-xl text-yellow-600 dark:text-coolGray-900 text-center">
                  ຫຼຸດຜ່ອນແຮງງານຂອງຜູ້ຊາຍ
                </h3>
                <p className="max-w-md font-medium  text-yellow-500 dark:text-coolGray-900">
          ...
          <div className="w-full px-4 md:w-2/5">
            <div className="w-full mb-2 md:w-auto md:pr-10 md:mb-0">
              <h3 className="text-xl  text-white dark:text-coolGray-900 text-center">
